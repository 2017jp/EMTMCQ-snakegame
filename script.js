...
const questions = [
  {
    ...
    options: ["Volt", "Tesla", "Newton/Coulomb", "Joule"],
    answer: 2,
  },
  {
    q: "Which law states that the line integral of the magnetic field around any closed loop is equal to μ₀ times the total current enclosed?",
    options: ["Gauss's Law", "Faraday's Law", "Lenz's Law", "Ampère's Law"],
    answer: 3,
  },
  {
    q: "What does Gauss's Law relate?",
    options: [
  ...
  {
    q: "Which of the following describes Faraday's Law?",
